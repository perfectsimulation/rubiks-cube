...
/// turn on the Yellow side.
/// </summary>
public class Glide_Bccw : MonoBehaviour {
	...
	void Update () {
		...
		Quaternion rot1 = Quaternion.Euler (0, 90f, 0);
		Quaternion rot2 = Quaternion.Euler (0, 180f, 0);
		Quaternion rot3 = Quaternion.Euler (0, -90f, 0);
